...
const MESSAGES = {
  en: {
    ...
    actionOpenIntegration: 'Open {name}',
    ...
    statusToolNeedsConfiguration: '{name} is still unavailable. Configure it in Detected tools.',
    statusToolDetectedAfterRefresh: '{name} is available after checking again.',
    statusSuccessSubProjectCommandsSaved: 'Commands for {name} saved.',
    deleteProjectEyebrow: 'Protected action',
    deleteProjectTitle: 'Delete project?',
    deleteProjectCopy: 'This will remove {name} from Project Hub. Your folder on disk will not be deleted.',
    deleteProjectSystemAuthCopy: 'Your operating system may ask for the computer password. If the account has no password, confirm the system prompt and continue.',
    deleteProjectConfirm: 'Authorize and delete',
    deleteProjectAuthorizationCancelled: 'Project deletion was cancelled before authorization.',
    ...
    dashboardCopy:
      'Scan roots once, keep projects searchable, and launch installed editors or agents from the correct folder without context switching.',
    ...
    settingsTools: 'Detected tools',
    settingsToolsCopy: 'Review automatic detection, retry missing tools, or save a manual command/path override for known tools.',
    settingsToolsRefresh: 'Check again',
    settingsToolInstalled: 'Installed',
    settingsToolMissing: 'Missing',
    settingsToolSystem: 'System',
    settingsToolSourceDetected: 'Detected',
    settingsToolSourceManual: 'Manual override',
    settingsToolSourceSystem: 'System',
    settingsToolDetectedValue: 'Detected: {value}',
    settingsToolManualValue: 'Override: {value}',
    settingsToolReview: 'Review',
    settingsToolEdit: 'Edit',
    settingsToolConfigure: 'Configure',
    settingsToolReset: 'Reset',
    settingsToolSave: 'Save override',
    settingsToolUseCommand: 'Command',
    settingsToolUseExecutable: 'Path',
    settingsToolCommandPlaceholder: 'codex',
    settingsToolExecutablePlaceholder: '/Applications/Cursor.app',
    toolCategoryEditor: 'Editor',
    toolCategoryAgent: 'Agent',
    toolCategoryTerminal: 'Terminal',
    toolCategoryFileManager: 'File manager',
    ...
    projectDetailSubProjectBadge: 'Sub-project',
    projectDetailSubProjectCopy: 'Detected sub-project. Actions run from this folder.',
    projectDetailSubProjectCommandsCopy: 'These commands run from this sub-project folder.',
    projectDetailAddSubProjectCommand: 'Add command',
    projectDetailSaveSubProjectCommands: 'Save commands',
    projectDetailResetSubProjectCommands: 'Reset',
    projectDetailConfigureTool: 'Configure {name}',
    projectDetailOpenSubProjectAria: 'Open sub-project {name}',
    projectDetailInheritedFrom: 'Inside {name}',
    ...
    projectCardOpenIntegrationAria: 'Open {name} in {tool}',
  ...
  es: {
    ...
    actionOpenIntegration: 'Abrir {name}',
    actionOpenFileManager: '{manager}',
    ...
    statusToolNeedsConfiguration: '{name} sigue sin estar disponible. Configúralo en Herramientas detectadas.',
    statusToolDetectedAfterRefresh: '{name} quedó disponible después de revisar de nuevo.',
    statusSuccessSubProjectCommandsSaved: 'Se guardaron los comandos de {name}.',
    deleteProjectEyebrow: 'Acción protegida',
    deleteProjectTitle: '¿Eliminar proyecto?',
    deleteProjectCopy: 'Esto quitará {name} de Project Hub. La carpeta en disco no se va a borrar.',
    deleteProjectSystemAuthCopy: 'El sistema operativo puede pedir la contraseña del equipo. Si la cuenta no tiene contraseña, confirma el aviso del sistema y continúa.',
    deleteProjectConfirm: 'Autorizar y eliminar',
    deleteProjectAuthorizationCancelled: 'La eliminación del proyecto se canceló antes de autorizar.',
    sidebarDashboard: 'Dashboard',
    ...
    dashboardCopy:
      'Escanea raíces una vez, mantén los proyectos encontrables y abre editores o agentes instalados desde la carpeta correcta sin perder contexto.',
    ...
    settingsTools: 'Herramientas detectadas',
    settingsToolsCopy: 'Revisa la detección automática, reintenta herramientas faltantes o guarda un override manual de comando/ruta para herramientas conocidas.',
    settingsToolsRefresh: 'Revisar de nuevo',
    settingsToolInstalled: 'Instalado',
    settingsToolMissing: 'No instalado',
    settingsToolSystem: 'Sistema',
    settingsToolSourceDetected: 'Detectado',
    settingsToolSourceManual: 'Override manual',
    settingsToolSourceSystem: 'Sistema',
    settingsToolDetectedValue: 'Detectado: {value}',
    settingsToolManualValue: 'Override: {value}',
    settingsToolReview: 'Revisar',
    settingsToolEdit: 'Editar',
    settingsToolConfigure: 'Configurar',
    settingsToolReset: 'Restablecer',
    settingsToolSave: 'Guardar override',
    settingsToolUseCommand: 'Comando',
    settingsToolUseExecutable: 'Ruta',
    settingsToolCommandPlaceholder: 'codex',
    settingsToolExecutablePlaceholder: '/Applications/Cursor.app',
    toolCategoryEditor: 'Editor',
    toolCategoryAgent: 'Agente',
    toolCategoryTerminal: 'Terminal',
    toolCategoryFileManager: 'Administrador de archivos',
    ...
    projectDetailSubProjectBadge: 'Subproyecto',
    projectDetailSubProjectCopy: 'Subproyecto detectado. Las acciones se ejecutan desde esta carpeta.',
    projectDetailSubProjectCommandsCopy: 'Estos comandos se ejecutan desde la carpeta de este subproyecto.',
    projectDetailAddSubProjectCommand: 'Agregar comando',
    projectDetailSaveSubProjectCommands: 'Guardar comandos',
    projectDetailResetSubProjectCommands: 'Restablecer',
    projectDetailConfigureTool: 'Configurar {name}',
    projectDetailOpenSubProjectAria: 'Abrir subproyecto {name}',
    projectDetailInheritedFrom: 'Dentro de {name}',
    ...
    projectCardOpenIntegrationAria: 'Abrir {name} en {tool}',
