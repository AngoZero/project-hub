...
const MESSAGES = {
  en: {
    ...
    catalogEmptyTitle: 'No projects match this view.',
    catalogEmptyCopy: 'Add a project or adjust the active filters to see results here.',
    workspaceAll: 'All',
  ...
  es: {
    ...
    catalogEmptyTitle: 'No hay proyectos para esta vista.',
    catalogEmptyCopy: 'Agrega un proyecto o ajusta los filtros activos para ver resultados aquí.',
    workspaceAll: 'Todos',
