...
const MESSAGES = {
  en: {
    ...
    settingsToolsCopy: 'Project Hub only shows installed editors and agents in project launchers.',
  ...
  es: {
    ...
    settingsToolsCopy: 'Project Hub solo muestra editores y agentes instalados en los launchers de proyectos.',
